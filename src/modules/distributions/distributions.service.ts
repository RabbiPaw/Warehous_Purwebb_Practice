...
export class DistributionsService {
    ...
    SELECT 
      ...
      COALESCE(SUM(d.quantity * dt.sign), 0) as "totalQuantity"
    FROM distributions d
    INNER JOIN distribution_types dt ON dt.id = d.distribution_type_id
  ...
  `;
        ...
        if (warehouseId) {
            query += ` AND d.warehouse_id = '${warehouseId}'`;
        }
